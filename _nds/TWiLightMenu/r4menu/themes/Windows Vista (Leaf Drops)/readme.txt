--------------------------------------------------------------
Simply Vista 1.0 Build 17 Revision 2 Update 2-8-06
--------------------------------------------------------------
...
bitmap images, and another folder called "ebook".
	3. To use this skin on your M3 Simply or R4DS, 
first select the four bitmaps found directly inside the 
"_system_" folder. Copy those directly to the "_system_" 
folder on your MicroSD card. These four images will form
the base skin and it's menus. If you have the latest 
firmware, it also lets you skin the ebook reader. To use 
this feature, copy the two bitmaps from the _system_/ebook 
folder, and copy these to the _system_/ebook folder on your
card.
